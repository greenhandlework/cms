...
<head>
  <title>Login v3 - Pages - Appwork</title>
    ...
    <div class="authentication-inner">
      ...
      <div class="d-none d-lg-flex col-lg-8 align-items-center ui-bg-cover ui-bg-overlay-container p-5" style="background-image: url('assets/img/bg/21.jpg');">
        ...
        <div class="w-100 text-white px-5">
          <h1 class="display-2 font-weight-bolder mb-4">JOIN OUR
            <br>COMMUNITY</h1>
          ...
          <div class="w-100">
            ...
            <form class="my-5" id="logForm">
              ...
              <div class="d-flex justify-content-between align-items-center m-0">
                ...
                <button type="submit" name="log_in"  id="log_in" class="btn btn-primary"><span id="logText"></span></button>
              </div>
            </form>
            <!-- / Form -->
...
function redirext(){
	...
	window.location=url+"order_details/order";
}
				...
				$.ajax({
					...
					success:function(response){
						...
						if(response.error){
							...
							setTimeout(function(){redirext();}, 3000);
