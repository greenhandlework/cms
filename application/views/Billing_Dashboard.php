            ...
            <div class="row no-gutters bg-lighter bg-white container-p-x pb-3 container-m--x container-m--y mb-4">
              <div class="col-6 col-sm-3 col-md pt-3 pr-4">
                <div class="media align-items-center">
                  <div class=" text-twitter text-large"><i class="oi oi-grid-three-up d-block"></i></div>
                  <div class="media-body ml-3">
                    <div class="text-big font-weight-bold line-height-1"><?php echo($bugs->count);  ?></div>
                    <div class="text-light text-tiny font-weight-semibold line-height-1 mt-1">TOTAL SALES</div>
                  </div>
                </div>
              </div>
              <div class="col-6 col-sm-3 col-md pt-3 pr-4">
                <div class="media align-items-center">
                  <div class=" text-google text-large"><i class="ion ion-ios-swap d-block"></i></div>
                  <div class="media-body ml-3">
              ...
              <div class="col-6 col-sm-3 col-md pt-3 pr-4">
                <div class="media align-items-center">
                 <div class=" text-facebook text-large"><i class="ion ion-md-wallet d-block"></i></div>
                  <div class="media-body ml-3">
                    <div class="text-big font-weight-bold line-height-1"> <?php print_r($process->count) ?></div>
                    <div class="text-light text-tiny font-weight-semibold line-height-1 mt-1">PAID&nbsp;AMOUNT</div>
                  </div>
                </div>
              </div>
              <div class="col-6 col-sm-3 col-md pt-3 pr-4">
                <div class="media align-items-center">
                 <div class=" text-pinterest text-large"><i class="ion ion-logo-freebsd-devil d-block"></i></div>
                  <div class="media-body ml-3">
                    <div class="text-big font-weight-bold line-height-1"> <?php print_r($Complate->count) ?></div>
                    <div class="text-light text-tiny font-weight-semibold line-height-1 mt-1">UNPAID&nbsp;AMOUNT</div>
                  </div>
                </div>
              </div>
              <div class="col-6 col-sm-3 col-md pt-3 pr-4">
                <div class="media align-items-center">
                 ...
                 <div class="media-body ml-3">
                    ...
                    <div class="text-light text-tiny font-weight-semibold line-height-1 mt-1">RECIVES</div>
                  </div>
                </div>
              </div>
            </div>
           ...
           <div class="row no-gutters bg-lighter bg-white container-p-x pb-3 container-m--x container-m--y mb-4">
              ...
              <div class=" text-twitter text-large"><i class="fas fa-archive d-block"></i></div>
                  <div class="media-body ml-3">
                    ...
                    <div class="text-light text-tiny font-weight-semibold line-height-1 mt-1">REFUND/DAY</div>
                  </div>
                </div>
              </div>
              <div class="col-6 col-sm-3 col-md pt-3 pr-4">
                <div class="media align-items-center">
                 <div class=" text-google text-large"><i class="fas fa-baseball-ball d-block"></i></div>
                  <div class="media-body ml-3">
                    ...
                    <div class="text-light text-tiny font-weight-semibold line-height-1 mt-1">Vendo pay</div>
                  </div>
                </div>
              </div>
              <div class="col-6 col-sm-3 col-md pt-3 pr-4">
                ...
                <div class=" text-facebook text-large"><i class="fab fa-bandcamp d-block"></i></div>
                  <div class="media-body ml-3">
                    ...
                    <div class="text-light text-tiny font-weight-semibold line-height-1 mt-1">Gst</div>
                  </div>
                </div>
              </div>
              <div class="col-6 col-sm-3 col-md pt-3 pr-4">
                <div class="media align-items-center">
                  ...
                  <div class="media-body ml-3">
                    ...
                    <div class="text-light text-tiny font-weight-semibold line-height-1 mt-1">Excepted Sell</div>
                  </div>
                </div>
              </div>
              <div class="col-6 col-sm-3 col-md pt-3 pr-4">
                <div class="media align-items-center">
                 <div class=" text-instagram text-large"><i class="fas fa-images d-block"></i></div>
                  <div class="media-body ml-3">
                    ...
                    <div class="text-light text-tiny font-weight-semibold line-height-1 mt-1">Expeted Incomeing</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="card mb-4">
              <h5 class="card-header with-elements border-0 pt-3 pb-0">
                <span class="card-header-title">
                  <i class="ion ion-md-stats text-primary"></i>&nbsp; Total Sale And Refund</span>
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                ...
                <div class="card mb-4">
                  <h6 class="card-header with-elements border-0 pr-0 pb-0">
                    <div class="card-header-title">Order/Refund</div>
                    <div class="card-header-elements ml-auto">
              ...
              <div class="col-md-4">
               ...
               <div class="card mb-4">
                  <h6 class="card-header with-elements border-0 pr-0 pb-0">
                    <div class="card-header-title">Paid/Return</div>
                    <div class="card-header-elements ml-auto">
                      <div class="btn-group mr-3">
                        <button type="button" class="btn btn-sm btn-default icon-btn borderless btn-round md-btn-flat dropdown-toggle hide-arrow" data-toggle="dropdown">
                          <i class="ion ion-ios-more"></i>
                ...
                <div class="nav-tabs-top mb-4">
                  ...
                  <div class="tab-content">
                    <div class="tab-pane fade show active" id="sale-stats">
                      <table class="table table-striped table-bordered table-hover" id="seler">
                                      <thead>
                                         <tr>
